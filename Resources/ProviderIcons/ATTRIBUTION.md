...
the default Clawd pixel pose and body color shipped in Claude Code 2.1.220.
The marks remain trademarks of their respective owners and are used only to
identify the corresponding provider integration.

The complete upstream copyright and license notice is reproduced in
